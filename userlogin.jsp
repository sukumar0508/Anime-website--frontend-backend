  ...
  <div class="container">
    ...
    <%  
      ...
      try {
        ...
        conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE", "system", "sukumar");

        // Prepare the SQL query to check user credentials in the users table
        String query = "SELECT uname FROM register WHERE email = ? AND password = ?";
    ...
    %>
      <div class="success-message">
        ...
        <script>
          setTimeout(function() {
            window.location.href = "comixology.jsp";
